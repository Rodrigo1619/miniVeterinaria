...
<div class="md:flex justify-center md:gap-10 md:items-center">
    ...
    <form action="{{ route('client.store') }}" method="POST">
        ...
        <input type="submit" value="Registrar cliente" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold
...
<div>
        <nav class="flex justify-center font-bold uppercase text-gray-600 text-4xl mt-5">
            <a href="{{ route('client.see') }}" class="bg-sky-600 hover:bg-sky-700 text-white rounded-lg p-3">Ver a todos los clientes</a>
        </nav>
</div>
@endsection