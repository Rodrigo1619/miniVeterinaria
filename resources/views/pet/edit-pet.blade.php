...
<div class="md:flex justify-center md:gap-10 md:items-center">
    ...
    <form action="{{ route('pet.update', ['pet'=>$pet]) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-5">
        ...
        <input type="submit" value="Actualizar mascota" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold
